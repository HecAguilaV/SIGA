...
3.  **SIGA-APP**: La movilidad en manos de los usuarios.
4.  **SIGA-WEBCOMERCIAL**: El punto de contacto comercial y ventas.
...
**¿Por qué unificamos?**
-   **Visibilidad Total**: Permitir que tanto el equipo humano como los agentes de IA (Antigravity) tengan acceso a todo el ecosistema simultáneamente.
-   **Portabilidad**: Facilitar el trabajo fluido entre dispositivos (PC, MacBook, Nube) con un solo `git pull`.
-   **Microservicios**: Preparar el terreno para desacoplar aún más la lógica de negocio sin perder la coherencia del sistema.

**Arquitectura Agéntica:**
Se crea el directorio `arquitectura-agentica/` y `skills/` para que la IA no sea solo un asistente, sino una parte integral del equipo que entiende el contexto histórico y técnico de SIGA.

---

*La historia continúa con cada commit...*
