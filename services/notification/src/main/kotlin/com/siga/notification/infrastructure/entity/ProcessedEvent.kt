package com.siga.notification.infrastructure.entity
 ...
 *
 * Before processing any incoming email event, the consumer checks this table.
 * If the eventId already exists, the event is skipped (duplicate).
 * This prevents duplicate email sends when Kafka redelivers messages.
 */
@Entity
