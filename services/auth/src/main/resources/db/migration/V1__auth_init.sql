...
CREATE TABLE IF NOT EXISTS auth.user_permissions (
    ...
    CONSTRAINT fk_user_perm_user FOREIGN KEY (user_id) REFERENCES auth.users (id) ON DELETE CASCADE,
    CONSTRAINT fk_user_perm_permission FOREIGN KEY (permission_id) REFERENCES auth.permissions (id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS auth.user_stores (
    ...
    CONSTRAINT fk_user_store_user FOREIGN KEY (user_id) REFERENCES auth.users (id) ON DELETE CASCADE
);
